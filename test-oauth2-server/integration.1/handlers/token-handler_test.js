...
var BearerTokenType = require('oauth2-server/lib/token-types/bearer-token-type');
...
var PasswordGrantType = require('oauth2-server/lib/grant-types/password-grant-type');
...
var TokenHandler = require('oauth2-server/lib/handlers/token-handler');
var UnauthorizedClientError = require('oauth2-server/lib/errors/unauthorized-client-error');
var UnsupportedGrantTypeError = require('oauth2-server/lib/errors/unsupported-grant-type-error');
