...
var AuthenticateHandler = require('oauth2-server/lib/handlers/authenticate-handler');
var AuthorizeHandler = require('oauth2-server/lib/handlers/authorize-handler');
var CodeResponseType = require('oauth2-server/lib/response-types/code-response-type');
...
var InvalidScopeError = require('oauth2-server/lib/errors/invalid-scope-error');
var UnsupportedResponseTypeError = require('oauth2-server/lib/errors/unsupported-response-type-error');
var Promise = require('bluebird');
var Request = require('oauth2-server/lib/request');
var Response = require('oauth2-server/lib/response');
